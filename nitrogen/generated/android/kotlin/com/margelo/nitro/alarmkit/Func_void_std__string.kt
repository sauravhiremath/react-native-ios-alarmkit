...
/**
 * Represents the JavaScript callback `(alarmsJson: string) => void`.
...
fun interface Func_void_std__string: (String) -> Unit {
  ...
  @DoNotStrip
  @Keep
  override fun invoke(alarmsJson: String): Unit
}
...
class Func_void_std__string_cxx: Func_void_std__string {
  ...
  @Keep
  override fun invoke(alarmsJson: String): Unit
    = invoke_cxx(alarmsJson)

  @FastNative
  private external fun invoke_cxx(alarmsJson: String): Unit
}
...
class Func_void_std__string_java(private val function: (String) -> Unit): Func_void_std__string {
  ...
  @Keep
  override fun invoke(alarmsJson: String): Unit {
    return this.function(alarmsJson)
  }
}
